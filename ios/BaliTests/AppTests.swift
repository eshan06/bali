...
// The app target's own tests (B5b), hosted in the app on the iOS Simulator: what only the app holds.
// Everything the app only wires up is tested in its packages, on Linux too.
