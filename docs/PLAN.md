...
- **Phase 3 is under way** (2026-09-23): the step list under Phases replaces
  ...
  bell with the app force-quit) and B5b-2 (its app-side riders, an app test
  target among them, and #91's review); B5c is next.**
