...
- **Phase 3 is under way** (2026-09-23): the step list under Phases replaces
  ...
  on the phone) and B6b (Emergency Unlock over an unread standing, and
  a scan that joins no class — the owner's ruling); B6c is next.**
