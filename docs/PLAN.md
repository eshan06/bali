...
- **Phase 3 is under way** (2026-09-23): the step list under Phases replaces
  ...
  (the outbox tables), A4 (recorded, no longer current) and A5 (the contract
  fixtures) landed; A6–A8 are next.** Of the owner decisions Phase 3
...
- **A6** Join-code preview · **A7** `GET /v1/me/history` · **A8** edit own name — each after its screen design, which D1 has now approved, so none waits on the owner; A8 implements decision 8 (a name unique within each class, ignoring case)
