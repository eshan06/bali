...
- **Phase 3 is under way** (2026-09-23): the step list under Phases replaces
  ...
  fixtures), A6 (the join-code preview) and A7 (the student's history)
  landed; A8 is next.** Of the owner decisions Phase 3
...
- **A8** edit own name — after its screen design, which D1 has now approved, so it does not wait on the owner; implements decision 8 (a name unique within each class, ignoring case)
