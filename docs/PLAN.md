...
- **A6** Join-code preview · **A7** `GET /v1/me/history` · **A8** edit own name — each after its screen design, now done (D1 ✅); A8 implements decision 8 (a name unique within each class, ignoring case)
