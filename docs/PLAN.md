...
- **Phase 3 is under way** (2026-09-23): the step list under Phases replaces
  ...
  fixtures) and A6 (the join-code preview) landed; A7–A8 are next.** Of the owner decisions Phase 3
...
- **A7** `GET /v1/me/history` · **A8** edit own name — each after its screen design, which D1 has now approved, so neither waits on the owner; A8 implements decision 8 (a name unique within each class, ignoring case)
