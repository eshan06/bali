...
- **Phase 3 is under way** (2026-09-23): the step list under Phases replaces
  ...
  and B1c (the API client) — and B2 (the app skeleton and its macOS CI);
  B3 is next.** Of the
...
- **B6** NFC tap → local record → shield → outbox — 📱 The app's NFC entitlement and usage string are in (B2); v2 read the block with `NFCNDEFReaderSession`
